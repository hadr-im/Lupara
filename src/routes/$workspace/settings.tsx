      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 overflow-auto p-8 max-w-2xl">
          ...
          {activeSection === "about" && (
            <div className="space-y-4">
              <div>
                <h2 className="font-display text-lg font-semibold mb-1">About Lupara</h2>
              ...
              <div className="rounded-2xl border border-border/60 bg-card p-6 space-y-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--gradient-primary)]">
                  <span className="font-display text-2xl font-bold text-primary-foreground">L</span>
                </div>
                <div>
                  <div className="font-display text-xl font-semibold">Lupara</div>
                  <div className="text-xs text-muted-foreground">Operations OS for AIESEC event management</div>
                </div>
                <div className="grid grid-cols-2 gap-3 text-xs">
                  {[["Version", "1.0.0"], ["Build", "2025.06"], ["License", "Internal"], ["Support", "admin@lupara.app"]].map(([l, v]) => (
