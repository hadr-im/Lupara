...
export const pmTasks: PmTask[] = [
  ...
  { id: "PT-002", workspaceId: "pmewa", title: "Update member onboarding guide", description: "Revise the onboarding handbook to include Lupara platform instructions and updated RBAC roles.", priority: "medium", status: "in_progress", dueDate: "2025-06-25", assignedTo: "ocp-pmewa", assignedToName: "Fatma Rejeb", assignedToHue: 180, createdBy: "admin-mehdi", createdAt: "2025-06-03", publishedAt: "2025-06-03" },
